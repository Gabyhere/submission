...
export default class HomeView {
  ...
  mount() {
    ...
    this._q('#story-list')?.addEventListener('click', async (e) => {
      if (e.target.classList.contains('bookmark-btn')) {
        const story = {
          id: e.target.getAttribute('data-id'),
          name: e.target.getAttribute('data-name'),
          photoUrl: e.target.getAttribute('data-photo'),
    ...
    return stories
      ...
      <div class="story-card">
        ...
        <div class="story-content">
          ...
          <button class="bookmark-btn" data-id="${s.id}" data-name="${s.name}" data-photo="${s.photoUrl}" data-description="${s.description}">Bookmark</button>
